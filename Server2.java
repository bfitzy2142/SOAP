...
@WebService(targetNamespace = "http://localhost", serviceName = "ServiceA", endpointInterface = "ServiceAInterface", portName = "Server2port")
/**
 * @Class Server2: Communicates with the APIGateway to return a service to the
 *        client
 * 
 */
public class Server2 implements ServiceAInterface {
	 ...
	 * 
	 */
	public Server2(APIGateway publisher) {
	...
	public String getServiceA() {
		...
		System.out.println("REQ:" + publisher.getRequestnum() + " " + time.format(new Date()) + "\nClient: '" + host
				+ "' connected with the address '" + remoteAddr + "' on Server2 for ServiceA!");
		message = "This is Server 2, giving you Service A!";
